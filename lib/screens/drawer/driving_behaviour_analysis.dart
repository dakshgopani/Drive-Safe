...
// import 'dart:convert';
//
// class MotionClassificationPage extends StatefulWidget {
//   @override
//   _MotionClassificationPageState createState() => _MotionClassificationPageState();
// }
//
// class _MotionClassificationPageState extends State<MotionClassificationPage> {
...
//         setState(() {
//           List<String> newPredictedClasses = List<String>.from(result['predicted_classes']);
...
//     return Scaffold(
//       appBar: AppBar(
//         title: Text('Motion Classification'),
//       ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildMetricRow('Harsh Braking', 0.4, Colors.orange),
            _buildMetricRow('Cornering', 0.3, Colors.blue),
