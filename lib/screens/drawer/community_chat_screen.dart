...
class _DriverSafetyChatScreenState extends State<DriverSafetyChatScreen> {
  ...
  Future<void> _sendMessage(String message,
      {File? file, bool isEmergency = false}) async {
  ...
  Future<void> _shareIncident() async {
    try {
      ...
      String mapUrl = 'myapp://incident?lat=${position.latitude}&long=${position.longitude}';
